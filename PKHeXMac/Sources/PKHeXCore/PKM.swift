...
public final class PKM {
    ...
    public var nickname: String {
        get { Self.readString { pkhex_pkm_get_nickname(handle, $0, $1) } }
        set {
    ...
    public var spriteFileName: String {
        Self.readString { pkhex_pkm_get_sprite_file_name(handle, $0, $1) }
    }
    ...
    public func legalityReport(verbose: Bool = false) -> String {
        Self.readString { pkhex_pkm_get_legality_report(handle, $0, $1, verbose ? 1 : 0) }
    }
    ...
    static func readString(_ call: (UnsafeMutablePointer<UInt16>?, Int32) -> Int32) -> String {
...
/// Display-name lookups for species/move/nature IDs, backed by PKHeX.Core's current-language
/// string tables. Independent of any PKM instance.
public enum PokemonNames {
    public static func species(_ id: UInt16) -> String {
        PKM.readString { pkhex_species_get_name(id, $0, $1) }
    }

    public static func move(_ id: UInt16) -> String {
        PKM.readString { pkhex_move_get_name(id, $0, $1) }
    }

    public static func nature(_ id: UInt8) -> String {
        PKM.readString { pkhex_nature_get_name(id, $0, $1) }
    }
}
